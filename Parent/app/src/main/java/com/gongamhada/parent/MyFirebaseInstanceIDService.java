...
public class MyFirebaseInstanceIDService extends FirebaseMessagingService {
    ...
    private void sendNotification(RemoteMessage remoteMessage){
        ...
        try{
            ...
            studentName = jsonArray.getString("stdntName");
            academyName = jsonArray.getString("acaName");
            if(jsonArray.getString("gubun").equals("load")){
                status = " 차량에 탑승 ";
            }
            else if(jsonArray.getString("gubun").equals("unload")){
                status = " 차량에서 하차 ";
            }
            else{
                status = "에 도착 ";
